...
urlpatterns = [
    ...
    path("integrated_maps/", views.data_product_list),
    path("tissues", views.tissue_list),
    path("datasets", views.dataset_list),
    path("assays", views.assay_list),
    path("integrated_maps/<uuid:data_product_id>/", views.data_product_detail),
    ...
    path("integrated_maps/tissue/<str:tissuetype>/", views.data_products_by_tissue),
    path("integrated_maps/assay/<str:assayName>/", views.data_products_by_assay),
